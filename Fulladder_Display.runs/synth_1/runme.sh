...
HD_PWD='C:/Users/Jorre/VivadoProjects/Fulladder_Display/Fulladder_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fulladder_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fulladder_Display.tcl
