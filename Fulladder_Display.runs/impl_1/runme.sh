...
HD_PWD='C:/Users/Jorre/VivadoProjects/Fulladder_Display/Fulladder_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fulladder_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fulladder_Display.tcl -notrace
